...
* start:locales - pt-BR for rails, devise and simple_form
...
* start:bower - add config bower to install components on `vendor/assets/components`
* start:spec_helpers - add session helpers to `spec` and speeds specs
